...
import courgettesAlmaverde from "./MainImages/courgettesAlmaverde.jpg";
import courgettesAlmaverde1 from "./MainImages/courgettesAlmaverde1.jpg";
import jalapenoGreen from "./MainImages/jalapenoGreen.jpg";
import jalapenoGreen1 from "./MainImages/jalapenoGreen1.jpg";
import freshbergamot from "./MainImages/fresh-bergamot.jpg";
import londonSorbet from "./MainImages/londonSorbet.jpg";
import londonSorbet1 from "./MainImages/londonSorbet1.jpg";
import londonSorbet2 from "./MainImages/londonSorbet2.jpg";
import londonSorbet3 from "./MainImages/londonSorbet3.jpg";
import estrattoDilimone from "./MainImages/estrattoDilimone.jpg";
import estrattoDilimone1 from "./MainImages/estrattoDilimone1.jpg";
import pureaDilime from "./MainImages/pureaDilime.jpg";
import pureaDilime1 from "./MainImages/pureaDilime1.jpg";
import pineApple from "./MainImages/pineApple.jpg";
import pineApple1 from "./MainImages/pineApple1.jpg";
import estrattoDimelagrana from "./MainImages/estrattoDimelagrana.jpg";
import naturalAnor from "./MainImages/naturalAnor.jpg";
import naturalAnor1 from "./MainImages/naturalAnor1.jpg";
import naturalAnor2 from "./MainImages/naturalAnor2.jpg";
import PeanutButter from "./MainImages/PeanutButter.jpg";
import PeanutButter1 from "./MainImages/PeanutButter1.jpg";
import pinkertonAvocado from "./MainImages/pinkertonAvocado.jpg";
import pinkertonAvocado1 from "./MainImages/pinkertonAvocado1.jpg";
import chiquitaBananas from "./MainImages/chiquitaBananas.jpg";
import chiquitaBananas1 from "./MainImages/chiquitaBananas1.jpg";
import ButterPista1 from "./MainImages/ButterPista1.jpg";
import BasilPesto from "./MainImages/BasilPesto.jpg";
import BasilPesto1 from "./MainImages/BasilPesto1.jpg";
import BasilPesto2 from "./MainImages/BasilPesto2.jpg";
...
let Object = [
  ...
  },
  {
    ...
    img: [courgettesAlmaverde, courgettesAlmaverde1],
    from_price: 11.0,
    to_price: 18.0,
    total: {
      one_kg: 18.0,
  ...
  },
  {
    id: 13,
    name: "Chili Pepper",
    img: [jalapenoGreen, jalapenoGreen1],
    from_price: 7.0,
    to_price: 10.0,
    total: {
      half_kg: 10.0,
  ...
  },
  {
    ...
    name: "Fresh Bergamot",
    img: [
      organicOavelOrangeAlmaverde1,
      freshbergamot,
      organicOavelOrangeAlmaverde,
    ],
    from_price: 4.0,
    to_price: 10.0,
    total: {
  ...
  },
  {
    ...
    img: [londonSorbet, londonSorbet1, londonSorbet2, londonSorbet3],
    from_price: null,
    to_price: 12.0,
    total: {},
    discount_price: 15.0,
  ...
  },
  {
    id: 18,
    name: "Ratto Milk",
    img: [estrattoDilimone, estrattoDilimone1],
    from_price: null,
    to_price: 20.0,
    total: {},
    discount_price: null,
  ...
  },
  {
    ...
    img: [naturalAnor, naturalAnor1, naturalAnor2],
    from_price: null,
    to_price: 16.0,
    total: {},
    discount_price: 18.0,
  ...
  },
  {
    id: 24,
    name: "Peanut Butter",
    img: [PeanutButter, PeanutButter1],
    from_price: null,
    to_price: 10.0,
    total: {},
    discount_price: 12.0,
  ...
  },
  {
    ...
    img: [pinkertonAvocado, pinkertonAvocado1],
    from_price: 3.0,
    to_price: 5.0,
    total: {
      one_kg: 5.0,
  ...
  },
  {
    id: 30,
    name: "Bananas",
    img: [chiquitaBananas, chiquitaBananas1],
    from_price: 3.0,
    to_price: 18.0,
    total: {},
    discount_price: 19.0,
  ...
  },
  {
    id: 32,
    name: "Basil Pesto",
    img: [BasilPesto, BasilPesto1, BasilPesto2],
    from_price: null,
    to_price: 8.0,
    total: {},
    discount_price: 10.0,
  ...
  },
  {
    ...
    img: [orangeCauliflower1, orangeCauliflower],
    from_price: null,
    to_price: 10.0,
    total: {},
    discount_price: null,
